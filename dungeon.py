...
class Dungeon():
    ...
    def drawWumpus(self):
        ...
        for i in range(len(self.gameWorld.wLoc)):
            if config.useImage:
                self.wumpus.append(Image(self.convert2(self.gameWorld.wLoc[i].x, self.gameWorld.wLoc[i].y), "images/wumpus.gif"))
            else:
    ...
    def drawPits(self):
        ...
        for i in range(len(self.gameWorld.pLoc)):
            ...
            if config.useImage:
                self.pits.append(Image(self.convert2(self.gameWorld.pLoc[i].x, self.gameWorld.pLoc[i].y), "images/pit2.png"))
    ...
    def drawGold(self):
        ...
        for i in range(len(self.gameWorld.gLoc)):
            # If we use an image, do the same as for Link and the Wumpus
            if config.useImage:
                self.gold.append(Image(self.convert2(self.gameWorld.gLoc[i].x, self.gameWorld.gLoc[i].y), "images/gold2.gif"))
            # Otherwise, do the same as for the pits
            else:
